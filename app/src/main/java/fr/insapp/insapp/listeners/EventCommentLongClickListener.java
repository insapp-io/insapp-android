            ...
            alertDialogBuilder
                    ...
                    .setPositiveButton(context.getString(R.string.positive_button), new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            delete.execute(HttpGet.ROOTEVENT + "/" + event.getId() + "/comment/" + comment.getId() + "?token=" + HttpGet.sessionCredentials.getSessionToken());
            ...
            alertDialogBuilder
                    ...
                    .setPositiveButton(context.getString(R.string.positive_button), new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialogAlert, int id) {
                            ...
                            report.execute(HttpGet.ROOTEVENT + "/report/" + event.getId() + "/comment/" + comment.getId() + "?token=" + HttpGet.sessionCredentials.getSessionToken());
                        }
                    })
                    .setNegativeButton(context.getString(R.string.negative_button), new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialogAlert, int id) {
